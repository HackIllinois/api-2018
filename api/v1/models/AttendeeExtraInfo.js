...
*/
AttendeeExtraInfo.findByAttendeeId = (attendeeId) => AttendeeExtraInfo.where({ attendee_id: attendeeId }).fetch();
...
*/
AttendeeExtraInfo.findById = (id) => AttendeeExtraInfo.where({ id: id }).fetch();
